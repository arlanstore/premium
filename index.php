<html><head><center>
<link rel="icon" href="https://play-lh.googleusercontent.com/kWzxVAQlM-CPjT5J_do0GR5IJn7TPCr6zXzPaASmcVhgtiNFVmp2bYO9Q_JS94LELks" type="image/gif" />
<title>Autoscript.net </title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta property="og:title" content=""><meta property="og:description" content="DaysVPN"/><meta content="" name="Abstract"><meta name=""><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1">
...
<style type="text/css"> @import url('https://fonts.googleapis.com/css?family=Nunito');@import url('https://fonts.googleapis.com/css?family=Poiret+One');body, html {height: 100%;background-repeat: no-repeat; /*background-image: linear-gradient(rgb(12, 97, 33),rgb(104, 145, 162));*/background:black;position: relative;}#particles-js{ width: 100%; height: 100%; background-size: cover; background-position: 50% 50%; position: fixed; top: 0px; z-index:1;}h1{font:1.5em Cinzel,serif;font-weight:400;letter-spacing:.35em;text-shadow:0 0 25px rgba(254,254,255,.85);width:70%} } footer { margin: 20%; } #a { onmousedown:stop; animation-name: rotate ; animation-duration: 5s; animation-play-state: running; animation-timing-function: linear; animation-iteration-count: infinite; opacity: 1.0;filter: alpha(opacity=50);} img:hover {opacity: 1.0;filter: alpha(opacity=100);} @keyframes rotate{ 10% {transform:rotateY(36deg)} 20% {transform:rotateY(72deg)} 30% {transform:rotateY(108deg)} 40% {transform:rotateY(144deg)} 50% {transform:rotateY(180deg)} 60% {transform:rotateY(216deg)} 70% {transform:rotateY(252deg)} 80% {transform:rotateY(288deg)} 90% {transform:rotateY(324deg)} 100% {transform:rotateY(360deg)} }</style></head>

<body>

<!--- Whatsapp ---->
<div style="position:fixed;left:35px;bottom:35px;">
<a href="https://wa.me/6283805933853">
<img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" width="50" height="50"></button></a>
</div>

<!--- Telegram ---->
<div style="position:fixed;right:35px;bottom:35px;">
<a href="https://t.me/DaysVPN">
<img src="https://upload.wikimedia.org/wikipedia/commons/8/83/Telegram_2019_Logo.svg" width="43" height="49""></button></a>
</div>

<style type="text/css">.blink_me{font-size:40px;-webkit-animation-name:blinker;-webkit-animation-duration:2s;-webkit-animation-timing-function:linear;-webkit-animation-iteration-count:infinite;-moz-animation-name:blinker;-moz-animation-duration:2s;-moz-animation-timing-function:linear;-moz-animation-iteration-count:infinite;animation-name:blinker;animation-duration:1.5s;animation-timing-function:linear;animation-iteration-count:infinite;}@-moz-keyframes blinker{0% {opacity:1.0;}50% {opacity:0.0;}100% {opacity:1.0;}}@-webkit-keyframes blinker{ 0% {opacity:1.0;}50% {opacity:0.0;}100% {opacity:1.0;}}@keyframes blinker{0% {opacity:1.0;}50% {opacity:0.0;}100% {opacity:1.0;}}</style><br><br>
<blink><center><span class="blink_me"><font size="5" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 30px red;">WELLCOME</span><br><font size="5" color="bluewhite" face="Wallpoet" style="text-shadow: 5px 0px 30px red;">INDONESIA VPN SERVICE PROVIDER STORES</font></center><br>
<p style="font-family:courier,arial,helvetica;" align="center" >
    <font size="4" color="red"><b>What is VPN?</b></font><br>
    <font size="3" color="white">
    In general, the notion of VPN is a communication network technology that creates a secure network connection through a public network, such as the internet, or a private network owned by a service provider.<br>
    In other words, VPN is a connection between one network and another private network (private) through a public network (internet).<br><br>
    <b><strong>The following is an explanation of the meaning of each word in Virtual Private Network:</strong></p></b>
    <p style="font-family:courier,arial,helvetica;" align="left">
        <i><b><strong>Virtual :</strong></b> Things that are not real or pseudo, in the virtual world / internet.</i><br>
        <i><b><strong>Private :</strong></b> Things that are private, cannot be accessed by just anyone. To keep it secret from public networks, all data will be encrypted.</i><br>
        <i><b><strong>Network :</strong></b> Network of interconnected connections.</i><br>
</p>
<p style="font-family:courier,arial,helvetica;" align="center" >
    So, from the explanation above, it can be concluded that VPN is a connection or connection that occurs virtually on a particular network without an encrypted real connection.
    Currently there are many VPN service providers that we can find on the internet at affordable prices, one of which is https://vpnstores.firdausjr.xyz By using a VPN, your personal data and online activities will be securely encrypted so that it cannot be tracked or stolen by other parties. <br><br><br>
    <font size="5" color="red"><b>~ WEBSITE IS IN DEVELOPMENT ~</b></font>
</p>
...
<center><marquee scrollamount="5" width="100%">
<font size="2" color="lightblue" face="Wallpoet">OFFICIAL TEAM   |   <font size="2" color="white" face="Iceberg">Days - Firdaus - Neza - Afdhan - Horras - Wildy - Ajun - All gretongers indonesia</font></marquee></font>
</center>

</body>

<br>
    <span class="blink_me"><font size="4" color="Red" face="Wallpoet" style="text-shadow: 5px 0px 27px red;">Powered By Gretongers indonesia <br>
    <a href="https://fb.com/mdaihasbunallah">COPYRIGHT © 2021<br></span>
</center>
